...
// Этот метод только и делает, что выкидывает ошибки Ильч изменил код)))
void test() {
...
int main(int argc, char** argv)
{
    ...
    // Программа выпадет с фатальной ошибкой и сюда выполнение уже не зайдёт. Печально. Из GitHub - весело

    return 0;

   //конец программы с фатальной ошибкой, программа крашиться 
